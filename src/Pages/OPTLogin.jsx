        ...
        <div className="flex justify-evenly h-screen items-center px-44 ">
            ...
            <div className="">
                ...
                <form className="flex flex-col my-20 ">
                    ...
                    <div class="flex flex-row gap-3 mt-3.5">
                        <input type="text" maxlength="1" class="w-14 h-14 text-center text-xl font-medium border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required />
                        <input type="text" maxlength="1" class="w-14 h-14 text-center text-xl font-medium border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required />
                        <input type="text" maxlength="1" class="w-14 h-14 text-center text-xl font-medium border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required />
                        <input type="text" maxlength="1" class="w-14 h-14 text-center text-xl font-medium border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required />
                        <input type="text" maxlength="1" class="w-14 h-14 text-center text-xl font-medium border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required />
                    ...
                    <p className="text-center text-[#374957] mt-2.5">
                        We’ll send a verification link to the<br /> number if it’s beign in our system
                    </p>
            ...
            <div className="bg-[#DEFEED] h-[85vh]  w-[50%] mb-6 pt-40 rounded-3xl flex justify-center items-center flex-col  ">
                ...
                <p className="text-center text-[#374957] mt-">
